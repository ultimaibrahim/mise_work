...
function ordenarPedido() {
  ...
  // Ordenar con Detección Automática Universal (Orden Custom de Sucursal > Categoría Alfabética)
  items.sort((a, b) => {
    ...
    // 4. FALLBACK UNIVERSAL: Si tampoco hay diferencia en F, ordena por Categoría alfabética
