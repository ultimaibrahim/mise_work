...
* **Algoritmo de Saneamiento Selectivo de Fondos**: La función `repararSistemaTienda` ahora realiza un escaneo previo en memoria para evaluar la integridad de fondos estáticos e hilos de sincronización. Si detecta pintura estática corrupta (como fondos grises pegados manualmente), destruye los formatos indeseados y restablece la paleta institucional alternada sin perder las cantidades capturadas por el usuario.
